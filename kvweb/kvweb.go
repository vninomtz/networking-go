...
func CHANGE(k string, n Node) bool {
  DATA[k] = n
  return true
}
...
func listAll(w http.ResponseWriter, r *http.Request)  {
	...
	fmt.Fprintf(w, "<a href=\"/\" style=\"margin-right: 20px;\"> List all elements! </a>")
	fmt.Fprintf(w, "<a href=\"/\" style=\"margin-right: 20px;\"> Change an element! </a>")
	fmt.Fprintf(w, "<a href=\"/\" style=\"margin-right: 20px;\"> Insert new element! </a>")
